...
| NGINX version | [Custom](https://github.com/kubernetes/ingress-nginx/tree/v1.9.0/images/nginx) NGINX build that includes several third-party modules | NGINX official mainline [build](https://github.com/nginxinc/docker-nginx) | NGINX Plus |
